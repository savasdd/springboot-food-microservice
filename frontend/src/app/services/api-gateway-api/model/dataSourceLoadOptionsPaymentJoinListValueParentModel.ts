...
export interface DataSourceLoadOptionsPaymentJoinListValueParentModel { 
    bindableType?: DataSourceLoadOptionsPaymentJoinListValueParentModel.BindableTypeEnum;
}
export namespace DataSourceLoadOptionsPaymentJoinListValueParentModel {
