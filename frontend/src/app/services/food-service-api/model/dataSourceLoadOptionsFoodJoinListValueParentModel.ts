...
export interface DataSourceLoadOptionsFoodJoinListValueParentModel { 
    bindableType?: DataSourceLoadOptionsFoodJoinListValueParentModel.BindableTypeEnum;
}
export namespace DataSourceLoadOptionsFoodJoinListValueParentModel {
