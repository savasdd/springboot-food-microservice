...
export interface DataSourceLoadOptionsOrdersJoinListValueParentModel { 
    bindableType?: DataSourceLoadOptionsOrdersJoinListValueParentModel.BindableTypeEnum;
}
export namespace DataSourceLoadOptionsOrdersJoinListValueParentModel {
