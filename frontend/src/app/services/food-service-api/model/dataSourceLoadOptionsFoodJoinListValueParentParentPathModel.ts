...
export interface DataSourceLoadOptionsFoodJoinListValueParentParentPathModel { 
    bindableType?: DataSourceLoadOptionsFoodJoinListValueParentParentPathModel.BindableTypeEnum;
}
export namespace DataSourceLoadOptionsFoodJoinListValueParentParentPathModel {
