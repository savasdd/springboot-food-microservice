...
export interface DataSourceLoadOptionsDepartmentJoinListValueParentModel { 
    bindableType?: DataSourceLoadOptionsDepartmentJoinListValueParentModel.BindableTypeEnum;
}
export namespace DataSourceLoadOptionsDepartmentJoinListValueParentModel {
