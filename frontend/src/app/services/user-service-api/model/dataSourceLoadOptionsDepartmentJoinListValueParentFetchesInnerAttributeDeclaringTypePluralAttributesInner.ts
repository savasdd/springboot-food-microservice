...
import { DataSourceLoadOptionsDepartmentJoinListValueParentFetchesInnerAttributeDeclaringTypeSingularAttributesInnerType } from './dataSourceLoadOptionsDepartmentJoinListValueParentFetchesInnerAttributeDeclaringTypeSingularAttributesInnerType';


export interface DataSourceLoadOptionsDepartmentJoinListValueParentFetchesInnerAttributeDeclaringTypePluralAttributesInner { 
    elementType?: DataSourceLoadOptionsDepartmentJoinListValueParentFetchesInnerAttributeDeclaringTypeSingularAttributesInnerType;
    collectionType?: DataSourceLoadOptionsDepartmentJoinListValueParentFetchesInnerAttributeDeclaringTypePluralAttributesInner.CollectionTypeEnum;
    name?: string;
    collection?: boolean;
    association?: boolean;
    javaMember?: DataSourceLoadOptionsDepartmentJoinListValueParentFetchesInnerAttributeDeclaringTypeAttributesInnerJavaMember;
    persistentAttributeType?: DataSourceLoadOptionsDepartmentJoinListValueParentFetchesInnerAttributeDeclaringTypePluralAttributesInner.PersistentAttributeTypeEnum;
    bindableType?: DataSourceLoadOptionsDepartmentJoinListValueParentFetchesInnerAttributeDeclaringTypePluralAttributesInner.BindableTypeEnum;
}
export namespace DataSourceLoadOptionsDepartmentJoinListValueParentFetchesInnerAttributeDeclaringTypePluralAttributesInner {
