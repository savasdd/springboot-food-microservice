...
export interface DataSourceLoadOptionsUserDepartmentJoinListValueParentModel { 
    bindableType?: DataSourceLoadOptionsUserDepartmentJoinListValueParentModel.BindableTypeEnum;
}
export namespace DataSourceLoadOptionsUserDepartmentJoinListValueParentModel {
