...
@RestController
@RequestMapping("/api/foods/users/departments")
public class UserDepartmentController {
    ...
    public ResponseEntity<LoadResult> getAllDepartmentUserLoad(@RequestBody DataSourceLoadOptions loadOptions) throws GeneralException, GeneralWarning {
